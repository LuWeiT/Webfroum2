        ...
        <div class="col-sm-4 offset-4" >
            <form class="" action="./login" method="post">
                ...
                <div class="form-group form-check">
                    ...
                    <a href="./register.jsp" style="float: right;text-decoration:underline;margin-right: 10px">注册</a>

                    <a href="./forget.jsp" style="float: right;margin-right: 10px;text-decoration:underline;">忘记密码</a>
