...
<div class="container jumbotron " style="margin-top: 50px">
    ...
    <div class="row">
        <div class="col-sm-4 offset-4" >
            <form class="" name="form"  action="./Register" method="post" id="form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password" id="psw1" required pattern="[0-9]+" >
                </div>
                <div class="form-group">
                    <label for="psw2">重复密码:</label>
                    <input type="password" class="form-control"  name="psw2" id="psw2"   onblur="check()" >
                    <label style="display: none;font-size: 10px;color:red;" id="label" >密码不一致，请重新输入</label>
                </div>
                <div class="form-group">
                    <label for="email">邮箱:</label>
                    <input type="email" class="form-control" name="emil" id="email" >
                </div>
                <br>
                <br>
