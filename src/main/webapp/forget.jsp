...
<script>
    ...
    function getCode(){
            $.get("./sendEmail?email="+document.getElementById("email").value+"&username="+document.getElementById("username").value,function(data) {
                    alert(data);
                }
            );
    }
        ...
        <div class="col-sm-4 offset-4" >
            <form >
                <div class="form-group">
                    <label >用户名:</label>
                    <input type="text" class="form-control" id="username" name="username" form="form"
                           required
                    >
                </div>
                <div class="form-group">
